...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand" href="{{route('home')}}">Kezdőlap</a>
...
{{--page level scripts (section endsection with scripts title at the specific pages)--}}
@yield('scripts')
